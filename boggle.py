...
def make_grid(width, height):
    ...
    for a boggle game
    """
    # the choice function returns an item from a list at random (in this case the list of 26 characters)
...
# the below if statement only runs main() if boggle.py is called in the command line (python3 boggle.py). If this is run from another file
# (eg pyhton3 -m unittest) it will not be run
